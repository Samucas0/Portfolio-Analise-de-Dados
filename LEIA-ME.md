...
Olá! Meu nome é Samuel Fernandes e este é o repositório onde documento minha jornada e projetos na área de Análise de Dados.

## 👨‍💻 Sobre Mim
Como **graduado em Análise e Desenvolvimento de Sistemas** com uma forte paixão por dados, decidi ir além da teoria. Atualmente, estou executando um plano de estudos intensivo e autodidata de 21 dias, onde construo um projeto prático de análise de dados por dia para criar um portfólio robusto e focado em negócios.
...
## 📂 Projetos
A tabela abaixo representa meu plano de estudo ativo. Estou desenvolvendo um projeto por dia para construir um portfólio forte e prático.
